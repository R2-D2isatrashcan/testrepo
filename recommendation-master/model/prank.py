...
class PersonalRank:
    ...
    def predict(self, user_id, top_n=100):
        """
        ...
        candidates = [key[5:] for key, value in self.params if key not in item_ids and 'user' not in key]
        os.remove('data/prank_{}.model'.format(user_id))
