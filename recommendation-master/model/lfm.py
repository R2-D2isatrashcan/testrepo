...
class LFM:
    ...
    def _optimize(self, user_id, item_id, e):
        ...
        e.g: E = 1/2 * (y - predict)^2, predict = matrloc_p * matrloc_q
             derivation(E, p) = -matrloc_q*(y - predict), derivation(E, q) = -matrloc_p*(y - predict),
    ...
    def predict(self, user_id, top_n=30):
        """
